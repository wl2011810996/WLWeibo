...
@interface WLNewFeatureController ()<UIScrollViewDelegate>
...
//        }
    ...
    scrollView.backgroundColor = WLColor(246, 246, 246);
...
//    pageControl.center.x = self.view.width * 0.5;
    pageControl.centerX = self.view.width * 0.5;
    pageControl.centerY = self.view.height - 30;
    [self.view addSubview:pageControl];
    
    // 2.设置圆点的颜色
    pageControl.currentPageIndicatorTintColor = WLColor(253, 98, 42); // 当前页的小圆点颜色
    pageControl.pageIndicatorTintColor = WLColor(189, 189, 189); // 非当前页的小圆点颜色
...
- (void)start
{
    ...
    WLTabBarViewController *vc = [[WLTabBarViewController alloc] init];
